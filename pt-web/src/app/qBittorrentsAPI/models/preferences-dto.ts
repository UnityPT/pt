...
export interface PreferencesDto {
  ...
  /**
   * For API 鈮?v2.5.1: Enable downloading of repack/proper Episodes
   */
  ...
  /**
   * For API 鈮?v2.5.1: List of RSS Smart Episode Filters
   */
  ...
  /**
   * For API 鈮?v2.5.1: List of custom http headers
   */
  ...
  /**
   * For API 鈮?v2.0.1: Path to SSL certificate
   */
  web_ui_https_cert_path?: string;

  /**
   * For API 鈮?v2.0.1: Path to SSL keyfile
   */
  ...
  /**
   * For API 鈮?v2.3.0: Plaintext WebUI password, not readable, write-only. For API < v2.3.0: MD5 hash of WebUI password, hash is generated from the following string: username:Web UI Access:plain_text_web_ui_password
   */
  ...
  /**
   * For API 鈮?v2.5.1: Enable custom http headers
   */
